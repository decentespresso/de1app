...
add_de1_text "settings_2a settings_2b" 45 755 -text [translate "1: preinfuse"] -font Helv_10_bold -fill "#7f879a" -anchor "nw" -width [rescale_x_skin 1200] -justify "left" 
	...
	add_de1_variable "settings_2a" 47 1000 -text "" -font Helv_8 -fill "#4e85f4" -anchor "nw" -width [rescale_x_skin 1200] -justify "left" -textvariable {[canvas_hide_if_zero $::settings(preinfusion_time) [list $::preinfusion_pressure_widget $::preinfusion_pressure_widget_label $::preinfusion_pressure_flow_widget $::preinfusion_pressure_flow_widget_label];  preinfusion_seconds_text $::settings(preinfusion_time)]}

	set ::preinfusion_pressure_widget [add_de1_widget "settings_2a" scale 670 850 {} -from $::de1(maxpressure) -to 0 -background $::settings(color_stage_1) -borderwidth 1 -showvalue 0  -bigincrement 1 -resolution .1 -length [rescale_y_skin 470] -width [rescale_x_skin 150] -variable ::settings(preinfusion_stop_pressure) -font Helv_10_bold -sliderlength [rescale_x_skin 125] -relief flat -command "profile_has_changed_set; update_de1_explanation_chart_soon" -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 ]
	set ::preinfusion_pressure_widget_label [add_de1_variable "settings_2a" 820 1325 -text "" -font Helv_8 -fill "#4e85f4" -anchor "ne" -width [rescale_x_skin 1200] -justify "left" -textvariable {< $::settings(preinfusion_stop_pressure) [translate bar]}]
	add_de1_button "settings_2a" { profile_has_changed_set; dui page open_dialog dui_number_editor ::settings(preinfusion_stop_pressure) -n_decimals 1 -min 1 -max $::de1(maxpressure) -default $::settings(preinfusion_stop_pressure) -smallincrement .1 -previous_values [::dui::pages::dui_number_editor::get_previous_values preinfusion_stop_pressure] -bigincrement 1 -use_biginc 1 -page_title [translate "Pressure"] -return_callback "::dui::pages::dui_number_editor::save_previous_value profile_has_changed_set preinfusion_stop_pressure"  } 650 1325 840 1425 ""   
	...
	add_de1_variable "settings_2b" 47 1000 -text "" -font Helv_8 -fill "#4e85f4" -anchor "nw" -width [rescale_x_skin 1200] -justify "left" -textvariable {[canvas_hide_if_zero $::settings(preinfusion_time) [list $::preinfusion_flow_widget $::preinfusion_flow_widget_label $::preinfusion_flow_pressure_widget $::preinfusion_flow_pressure_widget_label];  preinfusion_seconds_text $::settings(preinfusion_time)]}
	add_de1_button "settings_2a settings_2b" { profile_has_changed_set; dui page open_dialog dui_number_editor ::settings(preinfusion_time) -n_decimals 0 -min 1 -max 60 -default $::settings(preinfusion_time) -smallincrement 1 -previous_values [::dui::pages::dui_number_editor::get_previous_values preinfusion_time] -bigincrement 10 -use_biginc 1 -page_title [translate "Time"] -return_callback "::dui::pages::dui_number_editor::save_previous_value profile_has_changed_set preinfusion_time"  } 37 1000 600 1100 ""   

	set ::preinfusion_flow_widget [add_de1_widget "settings_2b" scale 670 850 {} -from $::de1(max_flowrate_v11) -to 0 -tickinterval 0  -showvalue 0 -background $::settings(color_stage_1)  -bigincrement 1 -resolution 0.1 -length [rescale_y_skin 470] -width [rescale_x_skin 150] -variable ::settings(preinfusion_flow_rate) -font Helv_15_bold -sliderlength [rescale_x_skin 125] -relief flat -command "profile_has_changed_set; update_de1_explanation_chart_soon; warn_if_flow_exceeds_de1_max" -foreground #000000 -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 ]
	set ::preinfusion_flow_widget_label [add_de1_variable "settings_2b" 820 1325 -text "" -font Helv_8 -fill "#4e85f4" -anchor "ne" -width [rescale_x_skin 1200] -justify "left" -textvariable {[return_flow_measurement $::settings(preinfusion_flow_rate)]}]



	set ::preinfusion_flow_pressure_widget [add_de1_widget "settings_2b" scale 47 1115 {} -to $::de1(maxpressure) -from 0  -background $::settings(color_stage_1) -borderwidth 1 -showvalue 0  -bigincrement 1 -resolution .1 -length [rescale_x_skin 600] -width [rescale_x_skin 150] -variable ::settings(preinfusion_stop_pressure) -font Helv_10_bold -sliderlength [rescale_x_skin 125] -relief flat -command "profile_has_changed_set; update_de1_explanation_chart_soon" -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 -orient horizontal ]
	set ::preinfusion_flow_pressure_widget_label [add_de1_variable "settings_2b" 47 1265 -text "" -font Helv_8 -fill "#4e85f4" -anchor "nw" -width [rescale_x_skin 1200] -justify "left" -textvariable {< $::settings(preinfusion_stop_pressure) [translate bar]}]
	add_de1_button "settings_2b" { profile_has_changed_set; dui page open_dialog dui_number_editor ::settings(preinfusion_stop_pressure) -n_decimals 1 -min 1 -max $::de1(maxpressure) -default $::settings(preinfusion_stop_pressure) -smallincrement .1 -bigincrement 1 -use_biginc 1 -page_title [translate "Pressure"] -previous_values [::dui::pages::dui_number_editor::get_previous_values preinfusion_stop_pressure] -return_callback "::dui::pages::dui_number_editor::save_previous_value profile_has_changed_set preinfusion_stop_pressure"  } 37 1265 437 1345 ""   

	set ::preinfusion_pressure_flow_widget [add_de1_widget "settings_2a" scale 47 1175 {} -to $::de1(max_flowrate_v11) -from 0 -tickinterval 0  -showvalue 0 -background $::settings(color_stage_1)  -bigincrement 1 -resolution 0.1 -length [rescale_x_skin 600] -width [rescale_x_skin 150] -variable ::settings(preinfusion_flow_rate) -font Helv_15_bold -sliderlength [rescale_x_skin 125] -relief flat -command "profile_has_changed_set; update_de1_explanation_chart_soon; warn_if_flow_exceeds_de1_max" -foreground #000000 -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 -orient horizontal ]
	set ::preinfusion_pressure_flow_widget_label [add_de1_variable "settings_2a" 47 1325 -text "" -font Helv_8 -fill "#4e85f4" -anchor "nw" -width [rescale_x_skin 1200] -justify "left" -textvariable {[return_flow_measurement $::settings(preinfusion_flow_rate)]}]

	add_de1_button "settings_2a" { profile_has_changed_set; dui page open_dialog dui_number_editor ::settings(preinfusion_flow_rate) -n_decimals 1 -min 1 -max $::de1(max_flowrate_v11) -default $::settings(preinfusion_flow_rate) -smallincrement .1 -bigincrement 1 -use_biginc 1 -page_title [translate "Flow rate"] -previous_values [::dui::pages::dui_number_editor::get_previous_values preinfusion_flow_rate] -return_callback "::dui::pages::dui_number_editor::save_previous_value flow_number_entry_pf preinfusion_flow_rate" } 37 1325 547 1425 ""   
	add_de1_button "settings_2b" { profile_has_changed_set; dui page open_dialog dui_number_editor ::settings(preinfusion_flow_rate) -n_decimals 1 -min 1 -max $::de1(max_flowrate_v11) -default $::settings(preinfusion_flow_rate) -smallincrement .1 -bigincrement 1 -use_biginc 1 -page_title [translate "Flow rate"] -previous_values [::dui::pages::dui_number_editor::get_previous_values preinfusion_flow_rate] -return_callback "::dui::pages::dui_number_editor::save_previous_value flow_number_entry_pf preinfusion_flow_rate"  } 650 1325 840 1425 ""   
...
add_de1_text "settings_2a" 890 755 -text [translate "2: rise and hold"] -font Helv_10_bold -fill "#7f879a" -anchor "nw" -width [rescale_x_skin 1200] -justify "left" 
	...
	add_de1_variable "settings_2 settings_2a" 892 1000 -text "" -font Helv_8 -fill "#4e85f4" -anchor "nw" -width [rescale_x_skin 1200] -justify "left" -textvariable {[canvas_hide_if_zero $::settings(espresso_hold_time) [list $::espresso_pressure_widget $::espresso_pressure_widget_label]; seconds_text $::settings(espresso_hold_time)]}
	...
	set ::espresso_pressure_widget [add_de1_widget "settings_2a" scale 1516 850 {} -to 0 -from $::de1(maxpressure) -tickinterval 0  -showvalue 0 -background $::settings(color_stage_2)  -bigincrement 1 -resolution 0.1 -length [rescale_y_skin 470] -width [rescale_x_skin 150] -variable ::settings(espresso_pressure) -font Helv_15_bold -sliderlength [rescale_x_skin 125] -relief flat -command "profile_has_changed_set; update_de1_explanation_chart_soon" -foreground #000000 -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0]
	set ::espresso_pressure_widget_label [add_de1_variable "settings_2 settings_2a" 1667 1325 -text "" -font Helv_8 -fill "#4e85f4" -anchor "ne" -width [rescale_x_skin 1200] -justify "left" -textvariable {[return_pressure_measurement $::settings(espresso_pressure)]}]
	add_de1_button "settings_2a" { profile_has_changed_set; dui page open_dialog dui_number_editor ::settings(espresso_pressure) -n_decimals 1 -min 1 -max $::de1(maxpressure) -default $::settings(espresso_pressure) -smallincrement .1 -bigincrement 1 -use_biginc 1 -page_title [translate "Pressure"] -previous_values [::dui::pages::dui_number_editor::get_previous_values espresso_pressure] -return_callback "::dui::pages::dui_number_editor::save_previous_value profile_has_changed_set espresso_pressure"  } 1500 1325 1680 1405 ""   
#	add_de1_button "settings_2a" { profile_has_changed_set; dui page open_dialog dui_number_editor ::settings(max_flowrate) -n_decimals 1 -min 1 -max $::de1(max_flowrate) -default $::settings(espresso_pressure) -smallincrement .1 -bigincrement 1 -use_biginc 1 -page_title [translate "Pressure"] -previous_values [::dui::pages::dui_number_editor::get_previous_values espresso_pressure] -return_callback "::dui::pages::dui_number_editor::save_previous_value profile_has_changed_set espresso_pressure" } 1500 1325 1680 1405 ""   
...
add_de1_text "settings_2a" 890 1120 -text [translate "Limit flow"] -font Helv_8_bold -fill "#7f879a" -anchor "nw" -width [rescale_x_skin 1200] -justify "left" 
	add_de1_widget "settings_2a" scale 892 1175 {} -from 0 -to $::de1(max_flowrate_v11) -background $::settings(color_stage_2)  -borderwidth 1 -showvalue 0  -bigincrement 1 -resolution 0.1 -length [rescale_x_skin 546] -width [rescale_x_skin 150] -variable ::settings(maximum_flow) -font Helv_10_bold -sliderlength [rescale_x_skin 125] -relief flat -command "" -orient horizontal -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0  -command "profile_has_changed_set; warn_if_flow_exceeds_de1_max"
...
add_de1_variable "settings_2a" 892 1325 -text "" -font Helv_8 -fill "#4e85f4" -anchor "nw" -width [rescale_x_skin 1200] -justify "left" -textvariable {[settings_flow_label]}

# "Limit flow" number-editor button, created AFTER its value label above so it is
# the top canvas layer and actually receives taps (previously the label covered it).
add_de1_button "settings_2a" { profile_has_changed_set; dui page open_dialog dui_number_editor ::settings(maximum_flow) -n_decimals 1 -min 1 -max $::de1(max_flowrate_v11) -default $::settings(maximum_flow) -smallincrement .1 -bigincrement 1 -use_biginc 1 -page_title [translate "Flow rate"] -previous_values [::dui::pages::dui_number_editor::get_previous_values maximum_flow] -return_callback "::dui::pages::dui_number_editor::save_previous_value flow_number_entry_pf maximum_flow"  } 882 1325 1372 1425 ""
...
add_de1_text "settings_2 settings_2a" 1730 755 -text [translate "3: decline"] -font Helv_10_bold -fill "#7f879a" -anchor "nw" -width [rescale_x_skin 1200] -justify "left" 
	...
	add_de1_variable "settings_2 settings_2a" 1735 1000 -text "" -font Helv_8 -fill "#4e85f4" -anchor "nw" -width [rescale_x_skin 1200] -justify "left" -textvariable {[canvas_hide_if_zero $::settings(espresso_decline_time) [list $::espresso_pressure_decline_widget $::espresso_pressure_decline_widget_label]; seconds_text $::settings(espresso_decline_time)]}

	
	set ::espresso_pressure_decline_widget [add_de1_widget "settings_2a" scale 2360 850 {} -from $::de1(maxpressure) -to 0 -background $::settings(color_stage_3) -showvalue 0 -borderwidth 1 -bigincrement 1 -resolution 0.1 -length [rescale_y_skin 470]  -width [rescale_x_skin 150] -variable ::settings(pressure_end) -font Helv_15_bold -sliderlength [rescale_x_skin 125] -relief flat -command "profile_has_changed_set; update_de1_explanation_chart_soon" -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 ]
	set ::espresso_pressure_decline_widget_label [add_de1_variable "settings_2 settings_2a" 2510 1325 -text "" -font Helv_8 -fill "#4e85f4" -anchor "ne" -width [rescale_x_skin 1200] -justify "left" -textvariable {[return_pressure_measurement $::settings(pressure_end)]}]
	add_de1_button "settings_2a" { profile_has_changed_set; dui page open_dialog dui_number_editor ::settings(pressure_end) -n_decimals 1 -min 1 -max $::de1(max_pressure) -default $::settings(pressure_end) -smallincrement .1 -bigincrement 1 -use_biginc 1 -page_title [translate "Pressure"] -previous_values [::dui::pages::dui_number_editor::get_previous_values pressure_end] -return_callback "::dui::pages::dui_number_editor::save_previous_value profile_has_changed_set pressure_end"  } 2350 1325 2550 1405 ""   

# display each temperature step, and if you tap on a number, allow editing of all at once
add_de1_button "settings_1 settings_2a settings_2b" {say [translate {temperature}] $::settings(sound_button_in); change_espresso_temperature 0.5; profile_has_changed_set } 2404 192 2590 320
...
add_de1_text "temperature_steps" 1280 290 -text [translate "Temperature Steps"] -font Helv_20_bold -width [rescale_x_skin 2400] -fill "#444444" -anchor "center" -justify "center" 
	...
	add_de1_widget "temperature_steps" scale 800 640 {} -from -30 -to 135 -background $::settings(color_stage_2) -borderwidth 1 -showvalue 0  -bigincrement 1 -resolution 0.5 -length [rescale_x_skin 970] -width [rescale_x_skin 150] -variable ::settings(espresso_temperature_1) -font Helv_10_bold -sliderlength [rescale_x_skin 125] -relief flat -command "" -orient horizontal -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 -command "range_check_shot_variables; profile_has_changed_set; update_de1_explanation_chart_soon"
	add_de1_widget "temperature_steps" scale 800 820 {} -from -30 -to 135 -background $::settings(color_stage_2) -borderwidth 1 -showvalue 0  -bigincrement 1 -resolution 0.5 -length [rescale_x_skin 970] -width [rescale_x_skin 150] -variable ::settings(espresso_temperature_2) -font Helv_10_bold -sliderlength [rescale_x_skin 125] -relief flat -command "" -orient horizontal -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 -command "range_check_shot_variables; profile_has_changed_set; update_de1_explanation_chart_soon"
	add_de1_widget "temperature_steps" scale 800 1000 {} -from -30 -to 135 -background $::settings(color_stage_2) -borderwidth 1 -showvalue 0  -bigincrement 1 -resolution 0.5 -length [rescale_x_skin 970] -width [rescale_x_skin 150] -variable ::settings(espresso_temperature_3) -font Helv_10_bold -sliderlength [rescale_x_skin 125] -relief flat -command "" -orient horizontal -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 -command "range_check_shot_variables; profile_has_changed_set; update_de1_explanation_chart_soon"
...
add_de1_text "settings_2b" 890 755 -text [translate "2: hold"] -font Helv_10_bold -fill "#7f879a" -anchor "nw" -width [rescale_x_skin 1200] -justify "left" 
	...
	add_de1_variable "settings_2b" 892 1000 -text "" -font Helv_8 -fill "#4e85f4" -anchor "nw" -width [rescale_x_skin 1200] -justify "left" -textvariable {[canvas_hide_if_zero $::settings(espresso_hold_time) [list $::flow_hold_widget $::flow_hold_widget_label]; seconds_text $::settings(espresso_hold_time)]}
	...
	set ::flow_hold_widget [add_de1_widget "settings_2b" scale 1516 850 {} -from $::de1(max_flowrate_v11) -to 0 -tickinterval 0  -showvalue 0 -background $::settings(color_stage_2)  -bigincrement 1 -resolution 0.1 -length [rescale_y_skin 470] -width [rescale_x_skin 150] -variable ::settings(flow_profile_hold) -font Helv_15_bold -sliderlength [rescale_x_skin 125] -relief flat -command "profile_has_changed_set; update_de1_explanation_chart_soon; warn_if_flow_exceeds_de1_max" -foreground #000000 -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 ]
	set ::flow_hold_widget_label [add_de1_variable "settings_2b" 1667 1325 -text "" -font Helv_8 -fill "#4e85f4" -anchor "ne" -width [rescale_x_skin 1200] -justify "left" -textvariable {[return_flow_measurement $::settings(flow_profile_hold)]}]
	add_de1_button "settings_2b" { profile_has_changed_set; dui page open_dialog dui_number_editor ::settings(flow_profile_hold) -n_decimals 1 -min 1 -max $::de1(max_flowrate_v11) -default $::settings(flow_profile_hold) -smallincrement .1 -bigincrement 1 -use_biginc 1 -page_title [translate "Flow rate"] -previous_values [::dui::pages::dui_number_editor::get_previous_values flow_profile_hold] -return_callback "::dui::pages::dui_number_editor::save_previous_value flow_number_entry_pf flow_profile_hold"  } 1500 1325 1700 1405 ""   
...
add_de1_text "settings_2b" 890 1120 -text [translate "Limit pressure"] -font Helv_8_bold -fill "#7f879a" -anchor "nw" -width [rescale_x_skin 1200] -justify "left" 
	...
	add_de1_variable "settings_2b" 892 1325 -text "" -font Helv_8 -fill "#4e85f4" -anchor "nw" -width [rescale_x_skin 1200] -justify "left" -textvariable {[settings_pressure_label]}
...
add_de1_text "settings_2b" 1730 755 -text [translate "3: decline"] -font Helv_10_bold -fill "#7f879a" -anchor "nw" -width [rescale_x_skin 1200] -justify "left" 
	...
	add_de1_variable "settings_2b" 1735 1000 -text "" -font Helv_8 -fill "#4e85f4" -anchor "nw" -width [rescale_x_skin 1200] -justify "left" -textvariable {[canvas_hide_if_zero $::settings(espresso_decline_time) [list $::flow_decline_widget $::flow_decline_widget_label]; seconds_text $::settings(espresso_decline_time)]}
	...
	set ::flow_decline_widget [add_de1_widget "settings_2b" scale 2360 850 {} -from $::de1(max_flowrate_v11) -to 0  -background $::settings(color_stage_3) -showvalue 0 -borderwidth 1 -bigincrement 1 -resolution 0.1 -length [rescale_y_skin 470]  -width [rescale_x_skin 150] -variable ::settings(flow_profile_decline) -font Helv_15_bold -sliderlength [rescale_x_skin 125] -relief flat -command "profile_has_changed_set; update_de1_explanation_chart_soon; warn_if_flow_exceeds_de1_max" -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 ]
	set ::flow_decline_widget_label [add_de1_variable "settings_2b" 2510 1325 -text "" -font Helv_8 -fill "#4e85f4" -anchor "ne" -width [rescale_x_skin 1200] -justify "left" -textvariable {[return_flow_measurement $::settings(flow_profile_decline)]}]
	add_de1_button "settings_2b" { profile_has_changed_set; dui page open_dialog dui_number_editor ::settings(flow_profile_decline) -n_decimals 1 -min 1 -max $::de1(max_flowrate_v11) -default $::settings(flow_profile_decline) -smallincrement .1 -bigincrement 1 -use_biginc 1 -page_title [translate "Flow rate"] -previous_values [::dui::pages::dui_number_editor::get_previous_values flow_profile_decline] -return_callback "::dui::pages::dui_number_editor::save_previous_value flow_number_entry_pf flow_profile_decline"  } 2340 1325 2610 1405 ""   
...
add_de1_text "settings_2c2" 70 230 -text [translate "Preheat water tank"] -font Helv_10_bold -fill "#7f879a" -anchor "nw" -width [rescale_x_skin 1600] -justify "center"
	...
	add_de1_variable "settings_2c2" 70 420 -text "" -font Helv_8 -fill "#4e85f4" -anchor "nw" -width [rescale_x_skin 1200] -justify "left" -textvariable {[return_temperature_setting_or_off $::settings(tank_desired_water_temperature)]}
	...
	add_de1_button "settings_2c2" { profile_has_changed_set; dui page open_dialog dui_number_editor ::settings(tank_desired_water_temperature) -n_decimals 0 -min 1 -max 45 -default $::settings(tank_desired_water_temperature) -smallincrement 1 -bigincrement 10 -use_biginc 1 -page_title [translate "Preheat water tank"] -previous_values [::dui::pages::dui_number_editor::get_previous_values tank_desired_water_temperature] -return_callback "::dui::pages::dui_number_editor::save_previous_value callback_after_adv_profile_data_entry tank_desired_water_temperature"  } 50 424 600 500 ""   
...
add_de1_text "settings_2c2" 970 530 -text [translate "After preinfusion, stop the shot at:"] -font Helv_10_bold -fill "#7f879a" -anchor "nw" -width [rescale_x_skin 1600] -justify "center"
	...
	add_de1_variable "settings_2c2" 970 720 -text "" -font Helv_8 -fill "#4e85f4" -anchor "nw" -width [rescale_x_skin 1200] -justify "left" -textvariable {[return_stop_at_volume_measurement $::settings(final_desired_shot_volume_advanced)]}
	...
	add_de1_button "settings_2c2" { profile_has_changed_set; dui page open_dialog dui_number_editor ::settings(final_desired_shot_volume_advanced) -n_decimals 0 -min 1 -max 2000 -default $::settings(final_desired_shot_volume_advanced) -smallincrement 1 -bigincrement 10 -use_biginc 1 -page_title [translate "Stop at water volume"] -previous_values [::dui::pages::dui_number_editor::get_previous_values final_desired_shot_volume_advanced] -return_callback "::dui::pages::dui_number_editor::save_previous_value callback_after_adv_profile_data_entry final_desired_shot_volume_advanced"  } 50 722 600 798 ""   
...
#		-smallincrement 1 -bigincrement 10 -editor_page yes -editor_page_title [translate "Stop at water volume"]	
	...
	add_de1_variable "settings_2c2" 70 720 -text "" -font Helv_8 -fill "#7f879a" -anchor "nw" -width [rescale_x_skin 1200] -justify "left" -textvariable {[when_to_start_pour_tracking_advanced]}
...
add_de1_variable "settings_2c2" 800 1020 -text "" -font Helv_8 -fill "#4e85f4" -anchor "nw" -width [rescale_x_skin 1200] -justify "left" -textvariable {$::settings(maximum_pressure_range_advanced) [translate bar]}
...
if {$::settings(scale_bluetooth_address) != "" || [::de1::packet::use_ble_v2]} {
	...
	add_de1_button "settings_2a settings_2b" { profile_has_changed_set; dui page open_dialog dui_number_editor ::settings(final_desired_shot_weight) -n_decimals 1 -min 1 -max 2000 -default $::settings(final_desired_shot_weight) -smallincrement .1 -bigincrement 1 -use_biginc 1 -page_title [translate "Stop at weight"] -previous_values [::dui::pages::dui_number_editor::get_previous_values final_desired_shot_weight] -return_callback "::dui::pages::dui_number_editor::save_previous_value profile_has_changed_set final_desired_shot_weight"  } 1720 1325 2110 1405 ""   
	...
	add_de1_variable "settings_2c2" 70 1320 -text "" -font Helv_8 -fill "#4e85f4" -anchor "nw" -width [rescale_x_skin 1200] -justify "left" -textvariable {[return_stop_at_weight_measurement $::settings(final_desired_shot_weight_advanced)]}

	add_de1_button "settings_2c2" { profile_has_changed_set; dui page open_dialog dui_number_editor ::settings(final_desired_shot_weight_advanced) -n_decimals 1 -min 0.1 -max 2000 -default $::settings(final_desired_shot_weight_advanced) -smallincrement 0.1 -bigincrement 1 -use_biginc 1 -page_title [translate "Stop at weight"] -previous_values [::dui::pages::dui_number_editor::get_previous_values final_desired_shot_weight_advanced] -return_callback "::dui::pages::dui_number_editor::save_previous_value callback_after_adv_profile_data_entry final_desired_shot_weight_advanced"  } 50 1130 600 1194 ""   
	add_de1_button "settings_2c2" { profile_has_changed_set; dui page open_dialog dui_number_editor ::settings(final_desired_shot_weight_advanced) -n_decimals 1 -min 0.1 -max 2000 -default $::settings(final_desired_shot_weight_advanced) -smallincrement 0.1 -bigincrement 1 -use_biginc 1 -page_title [translate "Stop at weight"] -previous_values [::dui::pages::dui_number_editor::get_previous_values final_desired_shot_weight_advanced] -return_callback "::dui::pages::dui_number_editor::save_previous_value callback_after_adv_profile_data_entry final_desired_shot_weight_advanced"  } 50 1324 600 1400 ""   
	...
	add_de1_variable "settings_2a settings_2b" 1730 1325 -text "" -font Helv_8 -fill "#4e85f4" -anchor "nw" -width [rescale_x_skin 1200] -justify "left" -textvariable {[return_stop_at_volume_measurement $::settings(final_desired_shot_volume)]}

	add_de1_button "settings_2a settings_2b" { profile_has_changed_set; dui page open_dialog dui_number_editor ::settings(final_desired_shot_volume) -n_decimals 1 -min 1 -max 100 -default $::settings(final_desired_shot_volume) -smallincrement .1 -bigincrement 1 -use_biginc 1 -page_title [translate "Stop at volume"] -previous_values [::dui::pages::dui_number_editor::get_previous_values final_desired_shot_volume] -return_callback "::dui::pages::dui_number_editor::save_previous_value profile_has_changed_set final_desired_shot_volume"  } 1720 1325 2110 1405 ""   
...
set ::advsteps_scrollbar [add_de1_widget "settings_2c" scale 10000 1 {} -from 0 -to 1.0 -bigincrement 0.2 -background "#d3dbf3" -borderwidth 1 -showvalue 0 -resolution .01 -length [rescale_x_skin 400] -width [rescale_x_skin 150] -variable ::advsteps_slider -font Helv_10_bold -sliderlength [rescale_x_skin 125] -relief flat -command {listbox_moveto $::advanced_shot_steps_widget $::advsteps_slider}  -foreground #FFFFFF -troughcolor "#f7f6fa" -borderwidth 0  -highlightthickness 0]
...
proc settings2c_flow_button {direction} {
	...
	if {[ifexists ::current_adv_step(pump)] == "flow"} {
		if {$direction eq "up"} {
			...
			if {$::current_adv_step(flow) > $::de1(max_flowrate_v11)} {
				set ::current_adv_step(flow) $::de1(max_flowrate_v11)
			}

		} else {
			set ::current_adv_step(flow) [round_to_one_digits [expr {$::current_adv_step(flow) - 0.1}]];
		}
		warn_if_flow_exceeds_de1_max
	} else {
		if {$direction eq "up"} {
			set ::current_adv_step(max_flow_or_pressure) [round_to_one_digits [expr {$::current_adv_step(max_flow_or_pressure) + 0.1}]];

			if {$::current_adv_step(max_flow_or_pressure) > $::de1(max_flowrate_v11)} {
				set ::current_adv_step(max_flow_or_pressure) $::de1(max_flowrate_v11)
			}
...
add_de1_variable "settings_2c" 2010 680 -text ""  -font Helv_6 -fill "#7f879a" -anchor "center" -width [rescale_x_skin 800] -justify "center"  -textvariable {[if {[ifexists ::current_adv_step(pump)] == "pressure"} {return [translate "pressure"]} else { return [translate "pressure limit"] }]}
...
proc tap_flow_text_label {} {
	profile_has_changed_set
	if {$::current_adv_step(pump) != "flow"} {
		dui page open_dialog dui_number_editor ::current_adv_step(max_flow_or_pressure) -n_decimals 1 -min 0 -max $::de1(max_flowrate_v11) -default $::current_adv_step(max_flow_or_pressure) -smallincrement 1 -bigincrement 2 -use_biginc 0 -page_title [translate "Flow limit"] -previous_values [::dui::pages::dui_number_editor::get_previous_values max_flow_or_pressure] -return_callback "::dui::pages::dui_number_editor::save_previous_value flow_limit_number_entry_adv max_flow_or_pressure"
	} else {
		dui page open_dialog dui_number_editor ::current_adv_step(flow) -n_decimals 1 -min 0 -max $::de1(max_flowrate_v11) -default $::current_adv_step(flow) -smallincrement 1 -bigincrement 2 -use_biginc 0 -page_title [translate "Flow rate goal"] -previous_values [::dui::pages::dui_number_editor::get_previous_values flow] -return_callback "::dui::pages::dui_number_editor::save_previous_value flow_number_entry_adv flow"
	}
...
if {$::settings(enable_fahrenheit) == 1} {
	add_de1_button "settings_2c" { set ::fahrenheit_water [round_to_integer [celsius_to_fahrenheit $::current_adv_step(temperature)]]; profile_has_changed_set; dui page open_dialog dui_number_editor ::fahrenheit_water -n_decimals 0 -min 0 -max [celsius_to_fahrenheit 105]  -smallincrement 1 -bigincrement 10 -use_biginc 1 -page_title [translate "Temperature"] -previous_values [::dui::pages::dui_number_editor::get_previous_values temperature] -return_callback "::dui::pages::dui_number_editor::save_previous_value temp_entry_callback temperature"  } 980 650 1150 780 ""   
} else {
	add_de1_button "settings_2c" { profile_has_changed_set; dui page open_dialog dui_number_editor ::current_adv_step(temperature) -n_decimals 1 -min 0 -max 105 -default $::current_adv_step(temperature) -smallincrement 0.5 -bigincrement 10 -use_biginc 1 -page_title [translate "Temperature"] -previous_values [::dui::pages::dui_number_editor::get_previous_values temperature] -return_callback "::dui::pages::dui_number_editor::save_previous_value callback_after_adv_profile_data_entry temperature"  } 980 650 1150 780 ""   
}
...
# draw the scrollbar off screen so that it gets resized and moved to the right place on the first draw
set ::profiles_scrollbar [add_de1_widget "settings_1" scale 10000 1 {} -from 0 -to 1.0 -bigincrement 0.2 -background "#d3dbf3" -borderwidth 1 -showvalue 0 -resolution .01 -length [rescale_x_skin 400] -width [rescale_x_skin 150] -variable ::profiles_slider -font Helv_10_bold -sliderlength [rescale_x_skin 125] -relief flat -command {listbox_moveto $::globals(profiles_listbox) $::profiles_slider}  -foreground #FFFFFF -troughcolor "#f7f6fa" -borderwidth 0  -highlightthickness 0]
...
#add_de1_button "settings_1" {say [translate {temperature}] $::settings(sound_button_in); change_espresso_temperature 0.5; profile_has_changed_set } 2380 230 2590 480
	...
	#add_de1_variable "settings_1" 2470 600 -text "" -font Helv_8_bold -fill "#4e85f4" -anchor "center" -textvariable {[round_and_return_temperature_setting ::settings(espresso_temperature)]}


add_de1_text "settings_3" 1304 220 -text [translate "Maintenance"] -font Helv_10_bold -fill "#7f879a" -justify "left" -anchor "nw"

	add_de1_text "settings_3" 2520 220 -text "\[[translate "Read Manual: Cleaning"]\]" -font Helv_8 -fill "#4e85f4" -anchor "ne" -width [rescale_x_skin 1000] -justify "right" 
...
if {[language] == "de"} {
	...
	add_de1_button "settings_3" {web_browser "https://decentespresso.com/doc/quickstart_zh/quickstart_zh.html#pf21"} 1300 210 2560 280 
} else {
	add_de1_button "settings_3" {web_browser "https://decentespresso.com/doc/quickstart/quickstart.html#pf21"} 1300 210 2560 280 
}
...
proc webServer {chan addr port} {
	...
	# disabled for now, using website instead
...
add_de1_text "settings_4" 50 220 -text [translate "Update App"] -font Helv_10_bold -fill "#7f879a" -justify "left" -anchor "nw"
	...
	add_de1_text "settings_4" 1240 226 -text "[app_updates_policy_as_text] v[package version de1app]" -width [rescale_x_skin 1000] -font Helv_8 -fill "#7f879a"  -justify "center" -anchor "ne"
	add_de1_variable "settings_4" 700 416 -text $::de1(app_update_button_label) -width [rescale_x_skin 1000] -font Helv_10_bold -fill "#FFFFFF"  -justify "center" -anchor "center" -textvariable {$::de1(app_update_button_label)} 
	add_de1_button "settings_4" {set ::de1(app_update_button_label) [translate "Updating"]; update_onscreen_variables; after 200 start_app_update} 20 320 1250 526
...
# buttons to other settings pages
	add_de1_text "settings_4" 1656 416 -text [translate "Skin"] -font Helv_10_bold -fill "#FFFFFF" -anchor "center" 
		...
		set ::skin_slider 0
		set ::skin_scrollbar [add_de1_widget "tabletstyles" scale 10000 1 {} -from 0 -to 1.0 -bigincrement 0.2 -background "#d3dbf3" -borderwidth 1 -showvalue 0 -resolution .01 -length [rescale_x_skin 400] -width [rescale_x_skin 150] -variable ::skin_slider -font Helv_10_bold -sliderlength [rescale_x_skin 125] -relief flat -command {listbox_moveto $::globals(tablet_styles_listbox) $::skin_slider}  -foreground #FFFFFF -troughcolor "#f7f6fa" -borderwidth 0  -highlightthickness 0]
	...
	add_de1_text "firmware_update_2" 40 20 -text [translate "Turn your DE1 on"] -font Helv_16_bold -width [rescale_x_skin 2400] -fill "#444444" -anchor "nw" -justify "left" 
		...
		add_de1_variable "firmware_update_2" 40 120 -text [translate "It can take one minute to start"] -font Helv_8 -fill "#222222" -anchor "nw" -width [rescale_x_skin 900] -justify "left" -textvariable {[if {$::de1(device_handle) != 0} { start_firmware_update; disable_de1_reconnect; page_show firmware_update_3}; return [translate "It can take one minute to start"]]}

	add_de1_variable "firmware_update_3" 40 20 -text "" -font Helv_16_bold -width [rescale_x_skin 2400] -fill "#444444" -anchor "nw" -justify "left" -textvariable {[check_firmware_update_is_available][translate $::de1(firmware_update_button_label)]} 
	...
	add_de1_text "firmware_update_4" 40 20 -text [translate "Turn your DE1 off"] -font Helv_16_bold -width [rescale_x_skin 2400] -fill "#444444" -anchor "nw" -justify "left" 
		...
		#add_de1_variable "firmware_update_5" 60 120 -text "" -font Helv_10_bold -fill "#222222" -anchor "nw" -width [rescale_x_skin 700] -justify "left" -textvariable {[if {$::de1(currently_updating_firmware) == 0} { page_show firmware_update_5 }; return [firmware_uploaded_label]]} 
	...
	add_de1_text "firmware_update_5" 40 20 -text [translate "Turn your DE1 on"] -font Helv_16_bold -width [rescale_x_skin 2400] -fill "#444444" -anchor "nw" -justify "left" 
		...
		add_de1_variable "firmware_update_5" 40 120 -text [translate "Please be patient. It can take several minutes for your DE1 to update."] -font Helv_8 -fill "#222222" -anchor "nw" -width [rescale_x_skin 840] -justify "left" -textvariable {[if {$::de1(device_handle) != 0} { app_exit }; return [translate "Please be patient. It can take several minutes for your DE1 to update."]]}
		#add_de1_text "firmware_update_6" 730 800 -text [translate "Please be patient. It can take several minutes for your DE1 to update."] -font Helv_8 -fill "#222222" -anchor "ne" -width [rescale_x_skin 700] -justify "right" 
	...
	add_de1_text "settings_4" 2290 416 -text [translate "Language"] -font Helv_10_bold -fill "#FFFFFF" -anchor "center" 
		...
		set ::languages_scrollbar [add_de1_widget "languages" scale 10000 1 {} -from 0 -to 1.0 -bigincrement 0.2 -background "#d3dbf3" -borderwidth 1 -showvalue 0 -resolution .01 -length [rescale_x_skin 400] -width [rescale_x_skin 150] -variable ::language_slider -font Helv_10_bold -sliderlength [rescale_x_skin 125] -relief flat -command {listbox_moveto $::languages_widget $::language_slider}  -foreground #FFFFFF -troughcolor "#f7f6fa" -borderwidth 0  -highlightthickness 0]
...
# grid [radiobutton .gender.femaleBtn -text "Female" -variable gender -value "Female"   -command "set  myLabel1 Female"] -row 1 -column 3				
				#add_de1_widget "measurements" scale 340 1010 {} -to 30 -from 0 -background #e4d1c1 -showvalue 0 -borderwidth 1 -bigincrement 1 -resolution 1 -length [rescale_x_skin 800]  -width [rescale_x_skin 100] -variable ::settings(app_update_delay_notification) -font Helv_15_bold -sliderlength [rescale_x_skin 125] -relief flat -command "" -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 -orient horizontal 
...
add_de1_text "settings_3" 55 544 -text [translate {Version}] -font Helv_10_bold -fill "#7f879a" -anchor "nw" -width [rescale_x_skin 1220] -justify "left" 
	add_de1_variable "settings_3" 55 616 -text "" -font Helv_7 -fill "#7f879a" -anchor "nw" -width [rescale_x_skin 1180] -justify "left" -textvariable {[de1_version_string]} 

#add_de1_text "settings_3" 1310 380 -text [translate "Water level"] -font Helv_7_bold -fill "#7f879a" -anchor "nw" -width [rescale_x_skin 1000] -justify "left" 
#	add_de1_variable "settings_3" 1600 380 -text "" -font Helv_7 -fill "#7f879a" -anchor "nw" -width [rescale_x_skin 1000] -justify "left" -textvariable {[round_to_integer $::de1(water_level)][translate mm]}
...
proc fetch_possible_de1_sn {} {
	...
	#add_de1_text "settings_3" 1310 350 -text [translate "Counter"] -font Helv_7_bold -fill "#7f879a" -anchor "nw" -width [rescale_x_skin 1000] -justify "left"

	add_de1_text "settings_3" 55 220 -text [translate "Counter"] -font Helv_10_bold -fill "#7f879a" -justify "left" -anchor "nw"
		add_de1_text "settings_3" 55 310 -text [translate "Espresso"] -font Helv_8 -fill "#7f879a" -anchor "nw" -width [rescale_x_skin 1000] -justify "left" 
		add_de1_text "settings_3" 55 370 -text [translate "Steam"] -font Helv_8 -fill "#7f879a" -anchor "nw" -width [rescale_x_skin 1000] -justify "left"
		add_de1_text "settings_3" 55 430 -text [translate "Hot water"] -font Helv_8 -fill "#7f879a" -anchor "nw" -width [rescale_x_skin 1000] -justify "left"
...
#trace add variable ::settings(scheduler_enable) write scheduler_feature_hide_show_refresh
	...
	add_de1_widget "settings_3" scale 50 1200 {} -from 0 -to 86340 -background #e4d1c1 -borderwidth 1 -bigincrement 600 -showvalue 0 -resolution 60 -length [rescale_x_skin 570] -width [rescale_x_skin 135] -variable ::settings(scheduler_wake) -font Helv_10_bold -sliderlength [rescale_x_skin 125] -relief flat -orient horizontal -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 -tags [list scheduler_scale_start scheduler]
	...
	add_de1_widget "settings_3" scale 670 1200 {} -from 0 -to 86340 -background #e4d1c1 -borderwidth 1 -bigincrement 600 -showvalue 0 -resolution 60 -length [rescale_x_skin 570] -width [rescale_x_skin 135] -variable ::settings(scheduler_sleep) -font Helv_10_bold -sliderlength [rescale_x_skin 125] -relief flat -orient horizontal -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 -tags [list scheduler_scale_end scheduler]
	...
	add_de1_variable "settings_3" 1240 1140 -text "" -font Helv_7 -fill "#7f879a" -anchor "ne" -width [rescale_x_skin 1000] -justify "right" -tags [list scheduler_scale_now_time scheduler] -textvariable {[translate "Now"] [time_format [clock seconds]]}
...
add_de1_text "settings_4" 55 970 -text [translate "Connect"] -font Helv_10_bold -fill "#7f879a" -justify "left" -anchor "nw"
	...
	add_de1_variable "settings_4" 2520 220 -text "" -font Helv_8 -fill "#4e85f4" -anchor "ne" -width [rescale_x_skin 1000] -justify "right" -textvariable {[decent_login_status_show]}
	...
	add_de1_variable "decent_login" 2300 900 -text "" -font Helv_8 -fill "#4e85f4" -anchor "ne" -width [rescale_x_skin 1000] -justify "right" -textvariable {[decent_email_support_link_show]}
	add_de1_variable "decent_login" 2300 1000 -text "" -font Helv_8 -fill "#4e85f4" -anchor "ne" -width [rescale_x_skin 1000] -justify "right" -textvariable {[decent_need_to_create_an_account_link_show]}
	add_de1_variable "decent_login" 2300 1100 -text "" -font Helv_8 -fill "#4e85f4" -anchor "ne" -width [rescale_x_skin 1000] -justify "right" -textvariable {[decent_password_forgot_link_show]}
...
proc send_decent_tech_support_email {} {
	...
	add_de1_text "settings_4" 60 1100 -text [translate "Espresso machine"] -font Helv_7_bold -fill "#7f879a" -justify "left" -anchor "nw"
		...
		set ::ble_slider 0
		set ::ble_scrollbar [add_de1_widget "settings_4" scale 10000 1 {} -from 0 -to 1.0 -bigincrement 0.2 -background "#d3dbf3" -borderwidth 1 -showvalue 0 -resolution .01 -length [rescale_x_skin 400] -width [rescale_x_skin 150] -variable ::ble_slider -font Helv_10_bold -sliderlength [rescale_x_skin 125] -relief flat -command {listbox_moveto $::ble_listbox_widget $::ble_slider}  -foreground #FFFFFF -troughcolor "#f7f6fa" -borderwidth 0  -highlightthickness 0]
	...
	add_de1_text "settings_4" 680 1100 -text [translate "Scale"] -font Helv_7_bold -fill "#7f879a" -justify "left" -anchor "nw"
		...
		set ::ble_scale_scrollbar [add_de1_widget "settings_4" scale 10000 1 {} -from 0 -to .90 -bigincrement 0.2 -background "#d3dbf3" -borderwidth 1 -showvalue 0 -resolution .01 -length [rescale_x_skin 400] -width [rescale_x_skin 150] -variable ::ble_scale_slider -font Helv_10_bold -sliderlength [rescale_x_skin 125] -relief flat -command {listbox_moveto $::ble_scale_listbox_widget $::ble_scale_slider}  -foreground #FFFFFF -troughcolor "#f7f6fa" -borderwidth 0  -highlightthickness 0]
...
add_de1_text "travel_prepare" 1280 120 -text [translate "Prepare your espresso machine for transport"] -font Helv_15_bold -fill "#a77171" -anchor "center" -width [rescale_x_skin 2000]
    ...
    add_de1_button "travel_do" {say [translate {awake}] $::settings(sound_button_in);start_idle; de1_send_waterlevel_settings} 0 0 2560 1600 "buttonnativepress"
...
add_de1_text "settings_3" 1304 1080  -text [translate "Water level"] -font Helv_10_bold -fill "#7f879a" -justify "left" -anchor "nw"
	add_de1_widget "settings_3" scale 1304 1170 {} -from 3 -to 70 -background #e4d1c1 -borderwidth 1 -bigincrement 1 -showvalue 0 -resolution 1 -length [rescale_x_skin 1190] -width [rescale_x_skin 115] -variable ::settings(water_refill_point) -font Helv_10_bold -sliderlength [rescale_x_skin 125] -relief flat -orient horizontal -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 
	add_de1_variable "settings_3" 1304 1300 -text "" -font Helv_7 -fill "#7f879a" -anchor "nw" -width [rescale_x_skin 1600] -justify "left" -textvariable {[translate "Refill at:"] [expr {$::settings(water_refill_point) + $::de1(water_level_mm_correction)}][translate mm]}
	add_de1_variable "settings_3" 2488 1120 -text "" -font Helv_7 -fill "#7f879a" -anchor "ne" -width [rescale_x_skin 1000] -justify "right" -textvariable {[translate "Now:"] [round_to_integer $::de1(water_level)][translate mm] (~[round_to_tens [water_tank_level_to_milliliters $::de1(water_level)]] [translate mL])}
	...
	#add_de1_variable "settings_4" 1240 760 -text "" -font Helv_7 -fill "#7f879a" -anchor "ne" -width [rescale_x_skin 1000] -justify "right" -textvariable {[translate "Now:"] [round_to_integer $::de1(water_level)][translate mm]}
...
add_de1_text "settings_4" 50 566 -text [translate "Screen brightness"] -font Helv_10_bold -fill "#7f879a" -justify "left" -anchor "nw"
	add_de1_widget "settings_4" scale 50 660 {} -from 0 -to 100 -background #e4d1c1 -borderwidth 1 -bigincrement 1 -showvalue 0 -resolution 1 -length [rescale_x_skin 1170] -width [rescale_x_skin 135] -variable ::settings(app_brightness) -font Helv_10_bold -sliderlength [rescale_x_skin 125] -relief flat -orient horizontal -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 -command {display_brightness}
	add_de1_variable "settings_4" 50 800 -text "" -font Helv_7 -fill "#7f879a" -anchor "nw" -width [rescale_x_skin 1600] -justify "left" -textvariable {[translate "App:"] $::settings(app_brightness)%}


add_de1_text "settings_3" 50 770 -text [translate "Energy saver"] -font Helv_10_bold -fill "#7f879a" -justify "left" -anchor "nw"
	add_de1_widget "settings_3" scale 50 870 {} -from 1 -to 480 -background #e4d1c1 -borderwidth 1 -bigincrement 1 -showvalue 0 -resolution 1 -length [rescale_x_skin 1170] -width [rescale_x_skin 135] -variable ::settings(screen_saver_delay) -font Helv_10_bold -sliderlength [rescale_x_skin 125] -relief flat -orient horizontal -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 
	add_de1_variable "settings_3" 50 1020 -text "" -font Helv_7 -fill "#7f879a" -anchor "nw" -width [rescale_x_skin 1600] -justify "left" -textvariable {[translate "Cool down after:"] [minutes_text $::settings(screen_saver_delay)]}
...
add_de1_button "settings_1" {say [translate {reset}] $::settings(sound_button_in); reset_default_profile; } 1800 1220 2280 1290
	...
	add_de1_variable "settings_1" 1360 900 -text "" -font Helv_6 -fill "#7f879a" -justify "left" -anchor "nw"  -width [rescale_x_skin 1150] -textvariable {[maxstring_with_crlf_count $::settings(profile_notes) 380 80 " \[[translate {Tap here for more}]\]" ]}
...
set calibration_row_spacing 115
...
if {1} {
	...
	# ::cupwarmer logic (procs) lives in bengle.tcl; page/layout follows below.
...
proc show_page_calibrate_3 {} {
	...
	page_to_show_when_off calibrate3
		...
		add_de1_text "calibrate2" 350 450  -text [translate "Voltage"] -font Helv_9_bold -fill "#7f879a" -anchor "nw" -justify "left" 
		...
		add_de1_widget "calibrate2" scale 350 660  {} -to 990 -from 0 -background #e4d1c1 -showvalue 0 -borderwidth 1 -bigincrement 5 -resolution 5 -length [rescale_x_skin 600]  -width [rescale_x_skin 90] -variable ::settings(hot_water_idle_temp) -font Helv_15_bold -sliderlength [rescale_x_skin 100] -relief flat -command {} -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 -orient horizontal 
		...
		add_de1_widget "calibrate2" scale 1350 660  {} -to 300 -from 10 -background #e4d1c1 -showvalue 0 -borderwidth 1 -bigincrement 1 -resolution 1 -length [rescale_x_skin 600]  -width [rescale_x_skin 90] -variable ::settings(espresso_warmup_timeout) -font Helv_15_bold -sliderlength [rescale_x_skin 100] -relief flat -command {} -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 -orient horizontal 
		...
		add_de1_widget "calibrate2" scale 350 860  {} -to 60 -from 5 -background #e4d1c1 -showvalue 0 -borderwidth 1 -bigincrement 1 -resolution 1 -length [rescale_x_skin 600]  -width [rescale_x_skin 90] -variable ::settings(phase_1_flow_rate) -font Helv_15_bold -sliderlength [rescale_x_skin 100] -relief flat -command {} -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 -orient horizontal 
		...
		add_de1_widget "calibrate2" scale 1350 860  {} -to 80 -from 5 -background #e4d1c1 -showvalue 0 -borderwidth 1 -bigincrement 1 -resolution 1 -length [rescale_x_skin 600]  -width [rescale_x_skin 90] -variable ::settings(phase_2_flow_rate) -font Helv_15_bold -sliderlength [rescale_x_skin 100] -relief flat -command {} -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 -orient horizontal 
...
proc send_refill_kit_override_from_gui {args} {
	send_refill_kit_override
		...
		add_de1_text "calibrate3" 350 510  -text [translate "Hot water flow rate"] -font Helv_7_bold -fill "#7f879a" -anchor "nw" -justify "left" 
		add_de1_widget "calibrate3" scale 350 560  {} -to 10 -from 1 -background #e4d1c1 -showvalue 0 -borderwidth 1 -bigincrement 1 -resolution .1 -length [rescale_x_skin 600]  -width [rescale_x_skin 90] -variable ::settings(hotwater_flow) -font Helv_15_bold -sliderlength [rescale_x_skin 100] -relief flat -command {} -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 -orient horizontal 
		...
		add_de1_text "calibrate3" 350 710  -text [translate "Flush flow rate"] -font Helv_7_bold -fill "#7f879a" -anchor "nw" -justify "left" 
		add_de1_widget "calibrate3" scale 350 760  {} -to 10 -from 1 -background #e4d1c1 -showvalue 0 -borderwidth 1 -bigincrement 1 -resolution .1 -length [rescale_x_skin 600]  -width [rescale_x_skin 90] -variable ::settings(flush_flow) -font Helv_15_bold -sliderlength [rescale_x_skin 100] -relief flat -command {} -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 -orient horizontal 
		...
		if {$::settings(skin) != "MimojaCafe" && $::settings(skin) != "DSx"} {
			...
			add_de1_text "calibrate3" 350 910  -text [translate "Flush timeout"] -font Helv_7_bold -fill "#7f879a" -anchor "nw" -justify "left" 
			add_de1_widget "calibrate3" scale 350 960  {} -to 120 -from 3 -background #e4d1c1 -showvalue 0 -borderwidth 1 -bigincrement 1 -resolution .1 -length [rescale_x_skin 600]  -width [rescale_x_skin 90] -variable ::settings(flush_seconds) -font Helv_15_bold -sliderlength [rescale_x_skin 100] -relief flat -command {} -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 -orient horizontal 
	...
	add_de1_text "calibrate" 500 $calibration_labels_row -text [translate "Saved"] -font Helv_8_bold -fill "#c0c4e1" -anchor "ne" 
		add_de1_variable "calibrate" 500 [expr {(1 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_8 -fill "#7f879a" -anchor "ne" -textvariable {[return_plus_or_minus_number $::de1(calibration_temperature)]}
		add_de1_variable "calibrate" 500 [expr {(2 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_8 -fill "#7f879a" -anchor "ne" -textvariable {[return_plus_or_minus_number $::de1(calibration_pressure)]}
		if {$enable_flow_calibration == 1} {
			#add_de1_variable "calibrate" 500 [expr {(3 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_8 -fill "#7f879a" -anchor "ne" -textvariable {[return_plus_or_minus_number $::de1(calibration_flow)]}
		}
		add_de1_variable "calibrate" 500 [expr {(4 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_8 -fill "#7f879a" -anchor "ne" -textvariable {[return_steam_heater_calibration $::settings(steam_temperature)]}
		add_de1_variable "calibrate" 500 [expr {(6 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_8 -fill "#7f879a" -anchor "ne" -textvariable {[return_steam_flow_calibration $::settings(steam_flow)]}

	add_de1_text "calibrate" 760 $calibration_labels_row -text [translate "Factory"] -font Helv_8_bold -fill "#c0c4e1" -anchor "ne" 
		add_de1_variable "calibrate" 760 [expr {(1 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_8 -fill "#7f879a" -anchor "ne" -textvariable {[return_plus_or_minus_number $::de1(factory_calibration_temperature)]}
		add_de1_variable "calibrate" 760 [expr {(2 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_8 -fill "#7f879a" -anchor "ne" -textvariable {[return_plus_or_minus_number $::de1(factory_calibration_pressure)]}
		if {$enable_flow_calibration == 1} {
			#add_de1_variable "calibrate" 760 [expr {(3 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_8 -fill "#7f879a" -anchor "ne" -textvariable {[return_plus_or_minus_number $::de1(factory_calibration_flow)]}
		}
		add_de1_variable "calibrate" 760 [expr {(4 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_8 -fill "#7f879a" -anchor "ne" -textvariable {[return_steam_heater_calibration $::settings(steam_temperature)]}
		add_de1_variable "calibrate" 760 [expr {(6 *$calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_8 -fill "#7f879a" -anchor "ne" -textvariable {[return_steam_flow_calibration $::settings(steam_flow)]}


	add_de1_text "calibrate" 850 $calibration_labels_row -text [translate "Sensor"] -font Helv_8_bold -fill "#c0c4e1" -anchor "nw" 
		add_de1_text "calibrate" 850 [expr {(1 * $calibration_row_spacing) + $calibration_labels_row}]  -text [translate "Temperature"] -font Helv_8_bold -fill "#7f879a" -anchor "nw"
		add_de1_text "calibrate" 850 [expr {(2 * $calibration_row_spacing) + $calibration_labels_row}]  -text [translate "Pressure"] -font Helv_8_bold -fill "#7f879a" -anchor "nw" 
		if {$enable_flow_calibration == 1} {
			add_de1_text "calibrate" 850 [expr {(3 * $calibration_row_spacing) + $calibration_labels_row}]  -text [translate "Flow"] -font Helv_8_bold -fill "#7f879a" -anchor "nw" 
		}
		add_de1_text "calibrate" 850 [expr {(4 * $calibration_row_spacing) + $calibration_labels_row}]  -text [translate "Steam temperature"] -font Helv_8_bold -fill "#7f879a" -anchor "nw" 
		add_de1_text "calibrate" 850 [expr {(6 *$calibration_row_spacing) + $calibration_labels_row}]  -text [translate "Steam flow rate"] -font Helv_8_bold -fill "#7f879a" -anchor "nw" 
		add_de1_text "calibrate2" 1350 1010 -text [translate "Stop at weight offset"] -font Helv_7_bold -fill "#7f879a" -anchor "nw"
		add_de1_text "calibrate" 850 [expr {(5 * $calibration_row_spacing) + $calibration_labels_row}]  -text [translate "Fan turns on at:"] -font Helv_8_bold -fill "#7f879a" -anchor "nw" 
	...
	add_de1_text "calibrate" 1750 $calibration_labels_row -text [translate "Goal"] -font Helv_8_bold -fill "#c0c4e1" -anchor "ne" 
		add_de1_variable "calibrate" 1750 [expr {(1 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_8 -fill "#7f879a" -anchor "ne" -textvariable {[return_temperature_setting $::settings(espresso_temperature)]}
		add_de1_variable "calibrate" 1750 [expr {(2 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_8 -fill "#7f879a" -anchor "ne" -textvariable {[return_pressure_measurement $::settings(espresso_pressure)]}
		if {$enable_flow_calibration == 1} {
			# add_de1_variable "calibrate" 1750 [expr {(3 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_8 -fill "#7f879a" -anchor "ne" -textvariable {[return_flow_measurement $::settings(flow_profile_hold)]}
			add_de1_variable "calibrate" 1750 [expr {(3 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_8 -fill "#7f879a" -anchor "ne" -textvariable {x $::settings(calibration_flow_multiplier)}
		}
		...
		add_de1_variable "calibrate" 1750 [expr {(4 * $calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_8 -fill "#7f879a" -anchor "ne" -textvariable {[return_steam_heater_calibration $::settings(steam_temperature)]}
		set ::steam_flow_rate_calibration_label [add_de1_variable "calibrate" 1750 [expr {(6 *$calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_8 -fill "#7f879a" -anchor "ne" -textvariable {[return_steam_flow_calibration $::settings(steam_flow)]}]
	...
	add_de1_text "calibrate" 1880 $calibration_labels_row -text [translate "Measured"] -font Helv_8_bold -fill "#c0c4e1" -anchor "nw" 
		...
		if {$enable_flow_calibration == 1} {
			...
			add_de1_widget "calibrate" scale 1880 [expr {(3 * $calibration_row_spacing) + $calibration_labels_row - [rescale_y_skin 16]}]  {} -to 2 -from 0.13 -background #e4d1c1 -showvalue 0 -borderwidth 1 -bigincrement .1 -resolution .01 -length [rescale_x_skin 400]  -width [rescale_x_skin 90] -variable ::settings(calibration_flow_multiplier) -font Helv_15_bold -sliderlength [rescale_x_skin 100] -relief flat -command {} -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 -orient horizontal 			
		}		
		
		#add_de1_widget "calibrate" scale 1880 875 {} -to 100 -from 60 -background #e4d1c1 -showvalue 0 -borderwidth 1 -bigincrement 1 -resolution 1 -length [rescale_x_skin 400]  -width [rescale_x_skin 100] -variable ::settings(shot_weight_percentage_stop) -font Helv_15_bold -sliderlength [rescale_x_skin 100] -relief flat -command {} -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 -orient horizontal 

		add_de1_widget "calibrate" scale 1880 [expr {(4 * $calibration_row_spacing) + $calibration_labels_row - [rescale_y_skin 16]}]  {} -to 170 -from 134 -background #e4d1c1 -showvalue 0 -borderwidth 1 -bigincrement 1 -resolution 1 -length [rescale_x_skin 400]  -width [rescale_x_skin 90] -variable ::settings(steam_temperature) -font Helv_15_bold -sliderlength [rescale_x_skin 100] -relief flat -command {} -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 -orient horizontal 
		...
		add_de1_widget "calibrate" scale 1880 [expr {(6 *$calibration_row_spacing) + $calibration_labels_row - [rescale_y_skin 16]}]  { set ::steam_flow_calibration_widget $widget } -to $max_steam_flow_rate -from 40 -background #e4d1c1 -showvalue 0 -borderwidth 1 -bigincrement 10 -resolution 10 -length [rescale_x_skin 400]  -width [rescale_x_skin 90] -variable ::settings(steam_flow) -font Helv_15_bold -sliderlength [rescale_x_skin 100] -relief flat -command {} -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 -orient horizontal 

		add_de1_variable "calibrate" 850 [expr {(6.5 * $calibration_row_spacing) + $calibration_labels_row - [rescale_y_skin 24]}]  -width [rescale_x_skin 1400]  -text "" -font Helv_6 -fill "#7f879a" -anchor "nw" -textvariable {[if {[ifexists ::settings(skin)] == "Insight" || [ifexists ::settings(skin)] == "Insight Dark" || [ifexists ::settings(skin)] == "Metric" || [ifexists ::settings(skin)] == "MiniMetric"} {
		...
		add_de1_widget "calibrate2" scale 1350 1060  {} -to 1.5 -from -1.0 -background #e4d1c1 -showvalue 0 -borderwidth 1 -bigincrement .1 -resolution .01 -length [rescale_x_skin 600]  -width [rescale_x_skin 90] -variable ::settings(stop_weight_before_seconds) -font Helv_15_bold -sliderlength [rescale_x_skin 100] -relief flat -command {} -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 -orient horizontal
...
#add_de1_variable "calibrate2" 1970 880  -text "" -font Helv_8 -fill "#7f879a" -anchor "nw" -textvariable {[return_flow_calibration_measurement $::settings(phase_2_flow_rate)]}
		...
		add_de1_widget "calibrate" scale 1880 [expr {(5 *$calibration_row_spacing) + $calibration_labels_row - [rescale_y_skin 16]}]  {} -to 60 -from 0 -background #e4d1c1 -showvalue 0 -borderwidth 1 -bigincrement 1 -resolution 1 -length [rescale_x_skin 400]  -width [rescale_x_skin 90] -variable ::settings(fan_threshold) -font Helv_15_bold -sliderlength [rescale_x_skin 100] -relief flat -command {} -foreground #FFFFFF -troughcolor $slider_trough_color -borderwidth 0  -highlightthickness 0 -orient horizontal 
		add_de1_variable "calibrate" 1750 [expr {(5 *$calibration_row_spacing) + $calibration_labels_row}]  -text "" -font Helv_10 -fill "#7f879a" -anchor "ne" -textvariable {[return_fan_threshold_calibration $::settings(fan_threshold)]}
...
if {1} {
	...
	# ::led picker logic (procs) lives in bengle.tcl; page/layout follows.
...
# ::bengle_fw logic (procs) lives in bengle.tcl; pages follow below.
...
#############################################################################
# "Stop at weight" quick-edit — tap the espresso data-card Weight line to set
# the profile's stop-at-weight in the full-screen number editor.
#
# The bound value depends on the profile type: advanced (steps) profiles use
# final_desired_shot_weight_advanced (the Limits tab); flow/pressure (simple)
# profiles use final_desired_shot_weight (the simple editors). Loaded here
# (de1_skin_settings.tcl is sourced by every skin via standard_includes); the
# tap target itself is added by the skin that draws the Weight line.
#############################################################################
namespace eval ::stopweight {}

# settings_2c / settings_2c2 are the advanced editor tabs; settings_2a
# (pressure) / settings_2b (flow) are the simple editors.
proc ::stopweight::is_advanced {} {
	return [expr {[ifexists ::settings(settings_profile_type)] in {settings_2c settings_2c2}}]
}

# The settings key holding the active profile's stop-at-weight.
proc ::stopweight::var {} {
	return [expr {[::stopweight::is_advanced] ? "final_desired_shot_weight_advanced" : "final_desired_shot_weight"}]
}

# Is a scale present? A separate BLE scale sets scale_bluetooth_address; an
# integrated BLE-v2 scale (e.g. the Bengle) does not, so also accept a live
# scale device handle or the v2 protocol being active.
proc ::stopweight::scale_present {} {
	if {[ifexists ::settings(scale_bluetooth_address) ""] ne ""} { return 1 }
	if {[ifexists ::de1(scale_device_handle) 0] != 0} { return 1 }
	if {![catch {::de1::packet::use_ble_v2} v] && $v} { return 1 }
	return 0
}

# The espresso data-card Weight line. With a scale present:
#   * live reading + target set -> "<current> < <target>"
#   * live reading, no target    -> "<current>"
#   * no live reading yet         -> "Stop at weight: <target>"  (tap to set)
# With no scale, returns "" (blank). $mode is "idle" or "espresso" and selects
# the same live-weight proc the original skin used for that page/profile type.
proc ::stopweight::weight_display {mode} {
	if {![::stopweight::scale_present]} { return "" }
	set target [ifexists ::settings([::stopweight::var]) 0]
	if {$mode eq "espresso"} {
		set cur [waterweight_text]
	} elseif {[::stopweight::is_advanced]} {
		set cur [drink_weight_text]
	} else {
		set cur [finalwaterweight_text]
	}
	if {[ifexists ::de1(scale_sensor_weight) ""] ne ""} {
		if {$target > 0} {
			return "$cur < [return_stop_at_weight_measurement $target]"
		}
		return $cur
	}
	# Scale present but no live reading yet: show the (tappable) target.
	return "[translate {Stop at weight}]: [return_stop_at_weight_measurement $target]"
}

# Idle (shot-not-running) two-line data-card display. Blank with no scale.
#   current_line -> "Current: <live scale weight>"
#   stop_line    -> "Stop at weight: <target>"
proc ::stopweight::current_line {} {
	if {![::stopweight::scale_present]} { return "" }
	set w [ifexists ::de1(scale_weight) ""]
	if {$w eq ""} { set w 0 }
	return "[translate {Current}]: [return_weight_measurement $w]"
}
proc ::stopweight::stop_line {} {
	if {![::stopweight::scale_present]} { return "" }
	return "[translate {Stop at}]: [return_stop_at_weight_measurement [ifexists ::settings([::stopweight::var]) 0]]"
}

# Open the full-screen number editor on the correct variable, mirroring the
# params/callbacks the settings-page editors use (see the settings_2* buttons).
proc ::stopweight::open_editor {} {
	say [translate {Stop at weight}] $::settings(sound_button_in)
	profile_has_changed_set
	if {[::stopweight::is_advanced]} {
		dui page open_dialog dui_number_editor ::settings(final_desired_shot_weight_advanced) \
			-n_decimals 1 -min 0.1 -max 2000 -default $::settings(final_desired_shot_weight_advanced) \
			-smallincrement 0.1 -bigincrement 1 -use_biginc 1 -page_title [translate "Stop at weight"] \
			-previous_values [::dui::pages::dui_number_editor::get_previous_values final_desired_shot_weight_advanced] \
			-return_callback "::dui::pages::dui_number_editor::save_previous_value callback_after_adv_profile_data_entry final_desired_shot_weight_advanced"
	} else {
		dui page open_dialog dui_number_editor ::settings(final_desired_shot_weight) \
			-n_decimals 1 -min 1 -max 2000 -default $::settings(final_desired_shot_weight) \
			-smallincrement .1 -bigincrement 1 -use_biginc 1 -page_title [translate "Stop at weight"] \
			-previous_values [::dui::pages::dui_number_editor::get_previous_values final_desired_shot_weight] \
			-return_callback "::dui::pages::dui_number_editor::save_previous_value profile_has_changed_set final_desired_shot_weight"
	}
}
