...
proc load_settings_vars {fn} {
	...
	# john 9-1-2024 changed our mind again to wanting it
...
proc range_check_shot_variables {} {
	...
	range_check_variable ::settings(grinder_dose_weight) 0 30
