package ifneeded de1_vars 1.1 [list source [file join "./" vars.tcl]]
...
package ifneeded de1_gui 1.1 [list source [file join "./" gui.tcl]]
...
package ifneeded de1_machine 1.1 [list source [file join "./" machine.tcl]]
...
package ifneeded de1_de1 1.0 [list source [file join "./" de1_de1.tcl]]
package ifneeded de1_device_scale 1.0 [list source [file join "./" device_scale.tcl]]
