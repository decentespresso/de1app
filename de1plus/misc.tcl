...
proc make_de1_dir {srcdir destdirs} {
    ...
    set files {
        ...
        certs/9f0f5fd6.0 *
        certs/ACCVRAIZ1.pem *
        certs/AC_RAIZ_FNMT-RCM.pem *
        certs/Actalis_Authentication_Root_CA.pem *
        certs/AffirmTrust_Commercial.pem *
        certs/AffirmTrust_Networking.pem *
        certs/AffirmTrust_Premium.pem *
        certs/AffirmTrust_Premium_ECC.pem *
        certs/Amazon_Root_CA_1.pem *
        certs/Amazon_Root_CA_2.pem *
        certs/Amazon_Root_CA_3.pem *
        certs/Amazon_Root_CA_4.pem *
        certs/Atos_TrustedRoot_2011.pem *
        certs/Autoridad_de_Certificacion_Firmaprofesional_CIF_A62634068.pem *
        certs/Baltimore_CyberTrust_Root.pem *
        certs/Buypass_Class_2_Root_CA.pem *
        certs/Buypass_Class_3_Root_CA.pem *
        certs/CA_Disig_Root_R2.pem *
        certs/CFCA_EV_ROOT.pem *
        certs/COMODO_Certification_Authority.pem *
        certs/COMODO_ECC_Certification_Authority.pem *
        certs/COMODO_RSA_Certification_Authority.pem *
        certs/Certigna.pem *
        certs/Certinomis_-_Root_CA.pem *
        certs/Certplus_Class_2_Primary_CA.pem *
        certs/Certum_Trusted_Network_CA.pem *
        certs/Certum_Trusted_Network_CA_2.pem *
        certs/Chambers_of_Commerce_Root_-_2008.pem *
        certs/Comodo_AAA_Services_root.pem *
        certs/Cybertrust_Global_Root.pem *
        certs/D-TRUST_Root_Class_3_CA_2_2009.pem *
        certs/D-TRUST_Root_Class_3_CA_2_EV_2009.pem *
        certs/DST_Root_CA_X3.pem *
        certs/Deutsche_Telekom_Root_CA_2.pem *
        certs/DigiCert_Assured_ID_Root_CA.pem *
        certs/DigiCert_Assured_ID_Root_G2.pem *
        certs/DigiCert_Assured_ID_Root_G3.pem *
        certs/DigiCert_Global_Root_CA.pem *
        certs/DigiCert_Global_Root_G2.pem *
        certs/DigiCert_Global_Root_G3.pem *
        certs/DigiCert_High_Assurance_EV_Root_CA.pem *
        certs/DigiCert_Trusted_Root_G4.pem *
        certs/E-Tugra_Certification_Authority.pem *
        certs/EC-ACC.pem *
        certs/EE_Certification_Centre_Root_CA.pem *
        certs/Entrust.net_Premium_2048_Secure_Server_CA.pem *
        certs/Entrust_Root_Certification_Authority.pem *
        certs/Entrust_Root_Certification_Authority_-_EC1.pem *
        certs/Entrust_Root_Certification_Authority_-_G2.pem *
        certs/GDCA_TrustAUTH_R5_ROOT.pem *
        certs/GeoTrust_Global_CA.pem *
        certs/GeoTrust_Primary_Certification_Authority.pem *
        certs/GeoTrust_Primary_Certification_Authority_-_G2.pem *
        certs/GeoTrust_Primary_Certification_Authority_-_G3.pem *
        certs/GeoTrust_Universal_CA.pem *
        certs/GeoTrust_Universal_CA_2.pem *
        certs/GlobalSign_ECC_Root_CA_-_R4.pem *
        certs/GlobalSign_ECC_Root_CA_-_R5.pem *
        certs/GlobalSign_Root_CA.pem *
        certs/GlobalSign_Root_CA_-_R2.pem *
        certs/GlobalSign_Root_CA_-_R3.pem *
        certs/GlobalSign_Root_CA_-_R6.pem *
        certs/Global_Chambersign_Root_-_2008.pem *
        certs/Go_Daddy_Class_2_CA.pem *
        certs/Go_Daddy_Root_Certificate_Authority_-_G2.pem *
        certs/Hellenic_Academic_and_Research_Institutions_ECC_RootCA_2015.pem *
        certs/Hellenic_Academic_and_Research_Institutions_RootCA_2011.pem *
        certs/Hellenic_Academic_and_Research_Institutions_RootCA_2015.pem *
        certs/Hongkong_Post_Root_CA_1.pem *
        certs/ISRG_Root_X1.pem *
        certs/IdenTrust_Commercial_Root_CA_1.pem *
        certs/IdenTrust_Public_Sector_Root_CA_1.pem *
        ...
        certs/OISTE_WISeKey_Global_Root_GC_CA.pem *
        certs/QuoVadis_Root_CA.pem *
        certs/QuoVadis_Root_CA_1_G3.pem *
        certs/QuoVadis_Root_CA_2.pem *
        certs/QuoVadis_Root_CA_2_G3.pem *
        certs/QuoVadis_Root_CA_3.pem *
        certs/QuoVadis_Root_CA_3_G3.pem *
        certs/SSL.com_EV_Root_Certification_Authority_ECC.pem *
        certs/SSL.com_EV_Root_Certification_Authority_RSA_R2.pem *
        certs/SSL.com_Root_Certification_Authority_ECC.pem *
        certs/SSL.com_Root_Certification_Authority_RSA.pem *
        certs/SZAFIR_ROOT_CA2.pem *
        certs/SecureSign_RootCA11.pem *
        certs/SecureTrust_CA.pem *
        certs/Secure_Global_CA.pem *
        certs/Security_Communication_RootCA2.pem *
        certs/Security_Communication_Root_CA.pem *
        certs/Sonera_Class_2_Root_CA.pem *
        certs/Staat_der_Nederlanden_EV_Root_CA.pem *
        certs/Staat_der_Nederlanden_Root_CA_-_G2.pem *
        certs/Staat_der_Nederlanden_Root_CA_-_G3.pem *
        certs/Starfield_Class_2_CA.pem *
        certs/Starfield_Root_Certificate_Authority_-_G2.pem *
        certs/Starfield_Services_Root_Certificate_Authority_-_G2.pem *
        certs/SwissSign_Gold_CA_-_G2.pem *
        certs/SwissSign_Silver_CA_-_G2.pem *
        certs/T-TeleSec_GlobalRoot_Class_2.pem *
        certs/T-TeleSec_GlobalRoot_Class_3.pem *
        certs/TUBITAK_Kamu_SM_SSL_Kok_Sertifikasi_-_Surum_1.pem *
        certs/TWCA_Global_Root_CA.pem *
        certs/TWCA_Root_Certification_Authority.pem *
        certs/Taiwan_GRCA.pem *
        certs/TeliaSonera_Root_CA_v1.pem *
        certs/TrustCor_ECA-1.pem *
        certs/TrustCor_RootCert_CA-1.pem *
        certs/TrustCor_RootCert_CA-2.pem *
        certs/Trustis_FPS_Root_CA.pem *
        certs/USERTrust_ECC_Certification_Authority.pem *
        certs/USERTrust_RSA_Certification_Authority.pem *
        certs/VeriSign_Class_3_Public_Primary_Certification_Authority_-_G4.pem *
        certs/VeriSign_Class_3_Public_Primary_Certification_Authority_-_G5.pem *
        certs/VeriSign_Universal_Root_Certification_Authority.pem *
        certs/Verisign_Class_3_Public_Primary_Certification_Authority_-_G3.pem *
        certs/XRamp_Global_CA_Root.pem *
        certs/a94d09e5.0 *
        certs/ad088e1d.0 *
        certs/aee5f10d.0 *
        certs/b0e59380.0 *
        ...
        certs/e73d606e.0 *
        certs/e8de2f56.0 *
        certs/ePKI_Root_Certification_Authority.pem *
        certs/ee64a828.0 *
        certs/eed8c118.0 *
        certs/ef954a4e.0 *
        certs/f060240e.0 *
        ...
        certs/thawte_Primary_Root_CA.pem *
        certs/thawte_Primary_Root_CA_-_G2.pem *
        certs/thawte_Primary_Root_CA_-_G3.pem *
