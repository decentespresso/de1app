...
namespace eval ::plugins::${plugin_name} {
    ...
    variable description [translate "Upload your last shot to visualizer.coffee"]
    variable name [translate "Upload to visualizer"]
    ...
    proc preload {} {
        ...
        add_de1_button $page_name {say [translate {Done}] $::settings(sound_button_in); plugins save_settings visualizer_upload; fill_extensions_listbox; page_to_show_when_off extensions; set_extensions_scrollbar_dimensions}  980 1210 1580 1410 ""
        ...
        add_de1_widget "$page_name" entry 280 540  {
            bind $widget <Return> { say [translate {save}] $::settings(sound_button_in); borg toast [translate "Saved"]; plugins save_settings visualizer_upload; hide_android_keyboard}
	...
	proc msg { msg } {
		::msg "::plugins::visualizer_upload: $msg"
	}
    ...
    proc upload {content} {
	    ...
	    if {[catch {
			...
			set settings(last_upload_result) "[translate {Upload failed!}] $err"
			plugins save_settings visualizer_upload
