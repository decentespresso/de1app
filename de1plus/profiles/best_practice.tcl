advanced_shot {{exit_if 0 flow 8.0 volume 100 max_flow_or_pressure_range 0.6 transition fast exit_flow_under 0 temperature 93.00 name Prefill pressure 3.0 sensor coffee pump flow exit_type pressure_over exit_flow_over 1.00 exit_pressure_over 3.00 max_flow_or_pressure 0 exit_pressure_under 0 seconds 2.00} {exit_if 1 flow 8.0 volume 100 max_flow_or_pressure_range 0.6 transition fast exit_flow_under 0 temperature 93.00 name Fill pressure 3.0 sensor coffee pump flow exit_type pressure_over exit_flow_over 1.00 exit_pressure_over 3.00 max_flow_or_pressure 0 seconds 12.00 exit_pressure_under 0} {exit_if 1 flow 6.8 volume 100 max_flow_or_pressure_range 0.6 transition fast exit_flow_under 3.00 temperature 88.00 name Compressing pressure 3.0 sensor coffee pump pressure exit_type flow_under exit_flow_over 1.00 exit_pressure_over 3.00 max_flow_or_pressure 0 seconds 12.00 exit_pressure_under 0} {exit_if 0 flow 6.8 volume 8.00 max_flow_or_pressure_range 0.6 transition smooth exit_flow_under 0 temperature 88.00 weight 8.00 name Dripping pressure 2.5 pump pressure sensor coffee exit_type flow_over exit_flow_over 1.00 exit_pressure_over 1.5 max_flow_or_pressure 0 exit_pressure_under 0 seconds 6.00} {exit_if 1 volume 100 max_flow_or_pressure_range 0.6 transition smooth exit_flow_under 0 temperature 88.00 name Pressurize pressure 11.0 sensor coffee pump pressure exit_type pressure_over exit_flow_over 6 exit_pressure_over 8.80 max_flow_or_pressure 0 exit_pressure_under 0 seconds 6.00} {exit_if 1 flow 1.5 volume 0 max_flow_or_pressure_range 0.6 transition fast exit_flow_under 0 temperature 88.00 name {Extraction start} pressure 3.0 sensor coffee pump flow exit_type pressure_over exit_flow_over 6 exit_pressure_over 0 max_flow_or_pressure 9.5 seconds 1 exit_pressure_under 0} {exit_if 0 flow 2.5 volume 100 max_flow_or_pressure_range 0.6 transition smooth exit_flow_under 0 temperature 88.00 name Extraction pressure 3.0 sensor coffee pump flow exit_flow_over 6 exit_pressure_over 11 max_flow_or_pressure 9.5 seconds 30.00 exit_pressure_under 0}}
