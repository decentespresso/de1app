advanced_shot {{exit_if 0 flow 8.00 volume 100 transition smooth exit_flow_under 0 temperature 0.0 name preinfusion pressure 10.00 sensor coffee pump pressure exit_type pressure_over exit_flow_over 6 exit_pressure_over 10.0 exit_pressure_under 0 seconds 10.00} {exit_if 0 volume 100 transition fast exit_flow_under 0 temperature 0.0 name {rise and hold} pressure 10.0 sensor coffee pump pressure exit_flow_over 6 exit_pressure_over 11 exit_pressure_under 0 seconds 5.00} {flow 0.00 exit_if 0 volume 100 transition fast exit_flow_under 0 temperature 0.0 name {hold at no flow} pressure 10.0 sensor coffee pump flow exit_flow_over 6 exit_pressure_over 11 exit_pressure_under 0 seconds 120.00}}
