...
#add_de1_widget "settings_1" scale 50 700 {} -to 0 -from 20 -background #FFFFFF -borderwidth 1 -bigincrement 0.5 -resolution 0.1 -length 600 -width 150 -variable ::settings(preinfusion_time) -font Helv_15_bold -sliderlength 100 -relief flat
#add_de1_text "settings_1" 240 1360 -text [translate "Preinfusion time"] -font Helv_10_bold -fill "#2d3046" -anchor "center" -width 400 -justify "center"
add_de1_widget "settings_1" checkbutton 80 780 {} -text [translate "Preinfusion"] -indicatoron true  -font Helv_15_bold -bg #FFFFFF -anchor nw -foreground #2d3046 -variable ::settings(preinfusion_enabled) -command update_de1_explanation_chart


add_de1_widget "settings_1" scale 560 814 {} -to 1 -from 10 -background #FFFFFF -borderwidth 1 -bigincrement 1 -resolution 0.1 -length 500 -width 150 -variable ::settings(espresso_pressure) -font Helv_15_bold -sliderlength 75 -relief flat -command update_de1_explanation_chart -foreground #4e85f4 -troughcolor #EEEEEE
add_de1_text "settings_1" 680 1325 -text [translate "Hold pressure"] -font Helv_15_bold -fill "#2d3046" -anchor "nw" -width 380 -justify "left"
...
add_de1_widget "settings_1" scale 2226 985 {} -to 0 -from 10 -background #FFFFFF -borderwidth 1 -bigincrement 1 -resolution 0.1 -length 330  -width 150 -variable ::settings(pressure_end) -font Helv_15_bold -sliderlength 75 -relief flat -command update_de1_explanation_chart -foreground #4e85f4 -troughcolor #EEEEEE
add_de1_text "settings_1" 2500 1325 -text [translate "Final pressure"] -font Helv_15_bold -fill "#2d3046" -anchor "ne" -width 380 -justify "left"

#add_de1_text "settings_1" 1550 1100 -text [translate "Your Espresso Profile"] -font Helv_20_bold -fill "#5a5d75" -anchor "n" -width 1200 -justify "center"
...
#add_de1_text "settings_1" 525 1350  -text "(Step 1)" -font Helv_8 -fill "#7f879a" -anchor "center" -anchor ne
#add_de1_text "settings_1" 1650 1350  -text "(Step 2)" -font Helv_8 -fill "#7f879a" -anchor "center" -anchor ne
#add_de1_text "settings_1" 1705 1350  -text "(Step 3)" -font Helv_8 -fill "#7f879a" -anchor "center" -anchor nw 
...
#add_de1_widget "settings_3" scale 50 250 {} -to $::de1(water_min_temperature) -from $::de1(water_max_temperature) -background #FFFFFF -borderwidth 1 -bigincrement 0.5 -resolution 0.1 -length 1000 -width 200 -variable ::settings(water_temperature) -font Helv_15_bold -sliderlength 100
#add_de1_text "settings_3" 310 1360 -text [translate "Hot water temperature"] -font Helv_10_bold -fill "#2d3046" -anchor "center" -width 400 -justify "center"

add_de1_text "settings_4" 90 250 -text [translate "Other"] -font Helv_10_bold -fill "#7f879a" -justify "left" -anchor "nw"
add_de1_text "settings_3" 1350 250 -text [translate "Flight mode"] -font Helv_10_bold -fill "#7f879a" -justify "left" -anchor "nw"

add_de1_text "settings_4" 130 400 -text [translate "Version: 1.0 beta 4"] -font Helv_10_bold -fill "#2d3046" -anchor "nw" -width 800 -justify "left"
add_de1_text "settings_4" 130 500 -text [translate "Serial number"] -font Helv_10_bold -fill "#2d3046" -anchor "nw" -width 800 -justify "left"
#add_de1_text "settings_4" 310 400 -text [translate "Wifi"] -font Helv_10_bold -fill "#2d3046" -anchor "left" -width 400 -justify "left"
add_de1_text "settings_4" 1390 700 -text [translate "Enable flight mode"] -font Helv_10_bold -fill "#2d3046" -anchor "nw" -width 800 -justify "left"
add_de1_text "settings_4" 1390 800 -text [translate "Flight mode start angle"] -font Helv_10_bold -fill "#2d3046" -anchor "nw" -width 800 -justify "left"

add_de1_text "settings_4" 310 800 -text [translate "Name"] -font Helv_10_bold -fill "#2d3046" -anchor "nw" -width 800 -justify "left"

#enable_fluid_ounces
add_de1_text "settings_4" 310 700 -text [translate "Use fluid ounces"] -font Helv_10_bold -fill "#2d3046" -anchor "nw" -width 800 -justify "left"
add_de1_text "settings_4" 310 800 -text [translate "Use Fahrenheit"] -font Helv_10_bold -fill "#2d3046" -anchor "nw" -width 800 -justify "left"
...
add_de1_widget "settings_3" scale 90 310 {} -from 0 -to 100 -background #FFFFFF -borderwidth 1 -bigincrement 1 -resolution 1 -length 1100 -width 135 -variable ::settings(app_brightness) -font Helv_10_bold -sliderlength 75 -relief flat -orient horizontal -foreground #4e85f4 -troughcolor #EEEEEE
add_de1_text "settings_3" 90 525 -text [translate "App brightness"] -font Helv_9 -fill "#2d3046" -anchor "nw" -width 800 -justify "left"

add_de1_widget "settings_3" scale 90 580 {} -from 0 -to 100 -background #FFFFFF -borderwidth 1 -bigincrement 1 -resolution 1 -length 1100 -width 135 -variable ::settings(saver_brightness) -font Helv_10_bold -sliderlength 75 -relief flat -orient horizontal -foreground #4e85f4 -troughcolor #EEEEEE
add_de1_text "settings_3" 90 785 -text [translate "Screen saver brightness"] -font Helv_9 -fill "#2d3046" -anchor "nw" -width 800 -justify "left"

add_de1_widget "settings_3" scale 90 840 {} -from 0 -to 120 -background #FFFFFF -borderwidth 1 -bigincrement 1 -resolution 1 -length 1100 -width 135 -variable ::settings(screen_saver_delay) -font Helv_10_bold -sliderlength 75 -relief flat -orient horizontal -foreground #4e85f4 -troughcolor #EEEEEE
add_de1_text "settings_3" 90 1045 -text [translate "Screen saver delay"] -font Helv_9 -fill "#2d3046" -anchor "nw" -width 800 -justify "left"

add_de1_widget "settings_3" scale 90 1100 {} -from 1 -to 120 -background #FFFFFF -borderwidth 1 -bigincrement 1 -resolution 1 -length 1100 -width 135 -variable ::settings(screen_saver_change_interval) -font Helv_10_bold -sliderlength 75 -relief flat -orient horizontal -foreground #4e85f4 -troughcolor #EEEEEE
add_de1_text "settings_3" 90 1305 -text [translate "Screen saver change interval"] -font Helv_9 -fill "#2d3046" -anchor "nw" -width 800 -justify "left"

add_de1_widget "settings_3" checkbutton 1350 400 {} -text [translate "Enable spoken prompts"] -indicatoron true  -font Helv_10 -bg #FFFFFF -anchor nw -foreground #2d3046 -variable ::settings(enable_spoken_prompts) 

add_de1_widget "settings_3" scale 1350 580 {} -from 0 -to 4 -background #FFFFFF -borderwidth 1 -bigincrement .1 -resolution .1 -length 1100 -width 135 -variable ::settings(speaking_rate) -font Helv_10_bold -sliderlength 75 -relief flat -orient horizontal -foreground #4e85f4 -troughcolor #EEEEEE
add_de1_text "settings_3" 1350 785 -text [translate "Speaking speed"] -font Helv_9 -fill "#2d3046" -anchor "nw" -width 800 -justify "left"

add_de1_widget "settings_3" scale 1350 840 {} -from 0 -to 3 -background #FFFFFF -borderwidth 1 -bigincrement .1 -resolution .1 -length 1100 -width 135 -variable ::settings(speaking_pitch) -font Helv_10_bold -sliderlength 75 -relief flat -orient horizontal -foreground #4e85f4 -troughcolor #EEEEEE
add_de1_text "settings_3" 1350 1045 -text [translate "Speaking pitch"] -font Helv_9 -fill "#2d3046" -anchor "nw" -width 800 -justify "left"
...
#add_de1_widget "settings_2" scale 50 250 {} -to $::de1(steam_min_temperature) -from $::de1(steam_max_temperature) -background #FFFFFF -borderwidth 1 -bigincrement 0.5 -resolution 0.1 -length 1000 -width 200 -variable ::settings(steam_temperature) -font Helv_15_bold -sliderlength 100
#add_de1_text "settings_2" 310 1360 -text [translate "Steam temperature"] -font Helv_10_bold -fill "#2d3046" -anchor "center" -width 400 -justify "center"
