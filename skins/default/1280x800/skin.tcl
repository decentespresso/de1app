...
if {[has_flowmeter] == 0} {
	...
	add_de1_text "steam" 1026 638 -justify right -anchor "ne" -text [translate "Temp:"] -font Helv_8 -fill "#7f879a" -width 260 
	...
	add_de1_text "steam" 895 525 -justify right -anchor "nw" -text [translate "Temp:"] -font Helv_8 -fill "#7f879a" -width 260 
...
add_de1_button "steam" "say [translate {stop}] $::settings(sound_button_out);start_idle" 0 0 1280 800
...
add_de1_button "off" "say [translate {steam}] $::settings(sound_button_out);start_steam" 874 308 1173 707
...
if {[has_flowmeter] == 0} {
	...
	add_de1_text "espresso" 640 638 -justify right -anchor "ne" -text [translate "Preinfusion:"] -font Helv_8 -fill "#7f879a" -width 260 
	...
	add_de1_text "espresso" 490 475 -justify right -anchor "nw" -text [translate "Preinfusion:"] -font Helv_8 -fill "#7f879a" -width 260 
...
add_de1_button "espresso" "say [translate {stop}] $::settings(sound_button_out);start_idle" 0 0 1280 800
...
add_de1_button "off" "say [translate {esspresso}] $::settings(sound_button_out);start_espresso" 474 292 803 722
...
if {[has_flowmeter] == 0} {
	...
	add_de1_text "water" 120 525 -justify right -anchor "nw" -text [translate "Water temp:"] -font Helv_8 -fill "#7f879a" -width 260 
...
add_de1_button "water" "say [translate {stop}] $::settings(sound_button_out);start_idle" 0 0 1280 800
...
add_de1_button "off" "say [translate {water}] $::settings(sound_button_out);start_water" 105 306 404 708
...
add_de1_button "off" "say [translate {sleep}] $::settings(sound_button_out);start_sleep" 0 0 200 200
add_de1_button "saver" "say [translate {awake}] $::settings(sound_button_out);start_idle" 0 0 1280 800

add_de1_text "sleep" 1250 725 -justify right -anchor "ne" -text [translate "Going to sleep"] -font Helv_20_bold -fill "#DDDDDD" 
add_de1_button "sleep" "say [translate {sleep}] $::settings(sound_button_out);start_sleep" 0 0 1280 800
