...
if {[has_flowmeter] == 0} {
	...
	add_de1_text "steam" 2053 1148.4011484011482 -justify right -anchor "ne" -text [translate "Temp:"] -font Helv_8 -fill "#7f879a" -width 520 
	...
	add_de1_text "steam" 1790 945.000945000945 -justify right -anchor "nw" -text [translate "Temp:"] -font Helv_8 -fill "#7f879a" -width 520 
...
add_de1_button "steam" "say [translate {stop}] $::settings(sound_button_out);start_idle" 0 0.0 2560 1440.00144000144
...
add_de1_text "off" 2053 1085.4010854010853 -justify right -anchor "ne" -text [translate "Temp:"] -font Helv_8 -fill "#7f879a" -width 520 
...
add_de1_button "off" "say [translate {steam}] $::settings(sound_button_out);start_steam" 1748 554.4005544005544 2346 1272.6012726012725
...
if {[has_flowmeter] == 0} {
	...
	add_de1_text "espresso" 1280 1148.4011484011482 -justify right -anchor "ne" -text [translate "Preinfusion:"] -font Helv_8 -fill "#7f879a" -width 520 
	...
	add_de1_text "espresso" 980 855.0008550008549 -justify right -anchor "nw" -text [translate "Preinfusion:"] -font Helv_8 -fill "#7f879a" -width 520 
...
add_de1_button "espresso" "say [translate {stop}] $::settings(sound_button_out);start_idle" 0 0.0 2560 1440.00144000144
...
add_de1_button "off" "say [translate {esspresso}] $::settings(sound_button_out);start_espresso" 948 525.6005256005255 1606 1299.6012996012996
...
if {[has_flowmeter] == 0} {
	...
	add_de1_text "water" 240 945.000945000945 -justify right -anchor "nw" -text [translate "Water temp:"] -font Helv_8 -fill "#7f879a" -width 520 
...
add_de1_button "water" "say [translate {stop}] $::settings(sound_button_out);start_idle" 0 0.0 2560 1440.00144000144
...
add_de1_button "off" "say [translate {water}] $::settings(sound_button_out);start_water" 210 550.8005508005508 808 1274.4012744012743
...
add_de1_button "off" "say [translate {sleep}] $::settings(sound_button_out);start_sleep" 0 0.0 400 360.00036000036
add_de1_button "saver" "say [translate {awake}] $::settings(sound_button_out);start_idle" 0 0.0 2560 1440.00144000144
...
add_de1_button "sleep" "say [translate {sleep}] $::settings(sound_button_out);start_sleep" 0 0.0 2560 1440.00144000144
