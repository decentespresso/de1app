...
add_de1_text "settings_4" 1310 650 -text [translate "Connect"] -font Helv_10_bold -fill "#7f879a" -justify "left" -anchor "nw"
	...
	if {[de1plus]} {
		...
		add_de1_widget "settings_4" listbox 1920 800 { 
			...
			} -background #fbfaff -font Helv_11 -bd 0 -height 3 -width 20 -foreground #d3dbf3 -borderwidth 0 -selectborderwidth 0  -relief flat -highlightthickness 0 -selectmode single -selectbackground #c0c4e1
