...
if {[has_flowmeter] == 0} {
	...
	add_de1_text "steam" 1539.7503849375962 861.2999999892338 -justify right -anchor "ne" -text [translate "Temp:"] -font Helv_8 -fill "#7f879a" -width 390.00009750002437 
	...
	add_de1_text "steam" 1342.5003356250838 708.7499999911406 -justify right -anchor "nw" -text [translate "Temp:"] -font Helv_8 -fill "#7f879a" -width 390.00009750002437 
...
add_de1_button "steam" "say [translate {stop}] $::settings(sound_button_out);start_idle" 0.0 0.0 1920.0004800001198 1079.9999999865001
...
add_de1_text "off" 1539.7503849375962 814.0499999898244 -justify right -anchor "ne" -text [translate "Temp:"] -font Helv_8 -fill "#7f879a" -width 390.00009750002437 
...
add_de1_button "off" "say [translate {steam}] $::settings(sound_button_out);start_steam" 1311.0003277500819 415.79999999480253 1759.5004398751098 954.4499999880694
...
if {[has_flowmeter] == 0} {
	...
	add_de1_text "espresso" 960.0002400000599 861.2999999892338 -justify right -anchor "ne" -text [translate "Preinfusion:"] -font Helv_8 -fill "#7f879a" -width 390.00009750002437 
	...
	add_de1_text "espresso" 735.0001837500458 641.2499999919844 -justify right -anchor "nw" -text [translate "Preinfusion:"] -font Helv_8 -fill "#7f879a" -width 390.00009750002437 
...
add_de1_button "espresso" "say [translate {stop}] $::settings(sound_button_out);start_idle" 0.0 0.0 1920.0004800001198 1079.9999999865001
...
add_de1_button "off" "say [translate {esspresso}] $::settings(sound_button_out);start_espresso" 711.0001777500444 394.1999999950725 1204.500301125075 974.6999999878163
...
if {[has_flowmeter] == 0} {
	...
	add_de1_text "water" 180.00004500001123 708.7499999911406 -justify right -anchor "nw" -text [translate "Water temp:"] -font Helv_8 -fill "#7f879a" -width 390.00009750002437 
...
add_de1_button "water" "say [translate {stop}] $::settings(sound_button_out);start_idle" 0.0 0.0 1920.0004800001198 1079.9999999865001
...
add_de1_button "off" "say [translate {water}] $::settings(sound_button_out);start_water" 157.50003937500983 413.09999999483625 606.0001515000379 955.7999999880526
...
add_de1_button "off" "say [translate {sleep}] $::settings(sound_button_out);start_sleep" 0.0 0.0 300.00007500001874 269.99999999662504
add_de1_button "saver" "say [translate {awake}] $::settings(sound_button_out);start_idle" 0.0 0.0 1920.0004800001198 1079.9999999865001
...
add_de1_button "sleep" "say [translate {sleep}] $::settings(sound_button_out);start_sleep" 0.0 0.0 1920.0004800001198 1079.9999999865001
