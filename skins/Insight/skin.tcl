...
add_de1_variable "tankempty refill" 1280 900 -justify center -anchor "center" -text "" -font Helv_10 -fill "#CCCCCC" -width 520 -textvariable {[return "s:$::de1(state) - b:$::de1(substate)"]} 
