...
add_de1_widget "off espresso espresso_1 espresso_2 espresso_3" graph 20 267 { 
	...
	$widget element create line_espresso_de1_explanation_chart_pressure -xdata espresso_de1_explanation_chart_elapsed -ydata espresso_de1_explanation_chart_pressure  -label "" -linewidth [rescale_x_skin 15] -color #4ef485  -smooth $::settings(preview_graph_smoothing_technique) -pixels [rescale_x_skin 25]; 
...
add_de1_widget "off_zoomed espresso_zoomed espresso_3_zoomed" graph 20 78 {
	...
	$widget element create line_espresso_de1_explanation_chart_pressure_zoomed -xdata espresso_de1_explanation_chart_elapsed -ydata espresso_de1_explanation_chart_pressure  -label "" -linewidth [rescale_x_skin 10] -color #4ef485  -smooth $::settings(preview_graph_smoothing_technique) -pixels [rescale_x_skin 15]; 
	...
	$widget element create line_espresso_de1_explanation_chart_flow_zoom -xdata espresso_de1_explanation_chart_elapsed_flow -ydata espresso_de1_explanation_chart_flow  -label "" -linewidth [rescale_x_skin 14] -color #4e85f4  -smooth $::settings(preview_graph_smoothing_technique) -pixels [rescale_x_skin 15]; 
