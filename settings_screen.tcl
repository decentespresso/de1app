...
} -width [expr {int(38 * $::globals(entry_length_multiplier))}] -font Helv_8  -borderwidth 1 -bg #fbfaff  -foreground #4e85f4 -textvariable ::iconik_settings(cleanup_profile) -relief flat  -highlightthickness 1 -highlightcolor #000000

# Screensaver folder
add_de1_text iconik_settings 180 720 -text [translate "Screensaver folder"] -font Helv_8 -width 300 -fill "#444444" -anchor "nw"
# The actual content. Here a list of all settings for this plugin
add_de1_widget "iconik_settings" entry 180 780  {
    set ::globals(widget_profile_name_to_save) $widget
    bind $widget <Return> { say [translate {save}] $::settings(sound_button_in); borg toast [translate "Saved"]; iconik_save_settings; hide_android_keyboard}
    bind $widget <Leave> hide_android_keyboard
} -width [expr {int(38 * $::globals(entry_length_multiplier))}] -font Helv_8  -borderwidth 1 -bg #fbfaff  -foreground #4e85f4 -textvariable ::iconik_settings(saver_dir) -relief flat  -highlightthickness 1 -highlightcolor #000000
